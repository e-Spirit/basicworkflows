...
import de.espirit.firstspirit.access.store.sitestore.DocLink;
 ...
 */
public class FakeDocumentGroup implements DocumentGroup {


    @Override
    public PageTemplate getPrefixTemplate() {
        return null;
    }

    @Override
    public void setPrefixTemplate(final PageTemplate pageTemplate) {

    }

    @Override
    public PageTemplate getSuffixTemplate() {
        return null;
    }

    @Override
    public void setSuffixTemplate(final PageTemplate pageTemplate) {

    }

    @Override
    public TemplateSet[] getGenerateFor() {
        return new TemplateSet[0];
    }

    @Override
    public void setGenerateFor(final TemplateSet[] templateSets) {

    }

    @Override
    public void setGenerateForToAll() {

    }

    @Override
    public boolean getGenerateForAll() {
        return false;
    }
    ...
    @Override
    public void setTemplateExtension(final String s) {

    }

    @Override
    public boolean containsElement(final StoreElement storeElement) {
        return false;
    }

    @Override
    public TemplateSet getDefaultTemplateSet() {
        return null;
    }

    @Override
    public void setDefaultTemplateSet(final TemplateSet templateSet) {

    }

    @Override
    public DocLink addLink(final IDProvider idProvider) {
        return null;
    }
