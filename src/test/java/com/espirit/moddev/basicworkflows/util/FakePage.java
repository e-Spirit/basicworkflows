...
public class FakePage implements Page {
    ...
    @Override
    public void setTemplate(final PageTemplate pageTemplate) {

    }

    @Override
    public Body getBodyByName(final String s) {
        return null;
    }
    ...
    @Override
    public void addTranslated(final Language language) {

    }

    @Override
    public void removeTranslated(final Language language) {

    }

    @Override
    public boolean isTranslated(final Language language) {
        return false;
    }
